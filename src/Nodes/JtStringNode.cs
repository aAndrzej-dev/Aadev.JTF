...
public sealed class JtStringNode : JtValueNode
{
    ...
    public override IJtSuggestionCollection Suggestions => suggestions ??= JtSuggestionCollection<string>.Create(this);

    internal static JtStringNode CreateSelf(IJtNodeParent parent) => new JtStringNode(parent);
    internal static JtStringNode CreateSelf(IJtNodeParent parent, JObject source) => new JtStringNode(parent, source);
