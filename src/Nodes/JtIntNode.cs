...
public sealed class JtIntNode : JtValueNode
{
    ...
    internal static JtIntNode CreateSelf(IJtNodeParent parent) => new JtIntNode(parent);
    internal static JtIntNode CreateSelf(IJtNodeParent parent, JObject source) => new JtIntNode(parent, source);
