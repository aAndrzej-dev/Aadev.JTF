...
public sealed class JtByteNodeSource : JtValueNodeSource
{
    ...
    internal static JtByteNodeSource CreateSelf(IJtNodeSourceParent parent) => new JtByteNodeSource(parent);
    internal static JtByteNodeSource CreateSelf(IJtNodeSourceParent parent, JObject source) => new JtByteNodeSource(parent, source);
